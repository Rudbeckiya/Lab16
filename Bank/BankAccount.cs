...
namespace BankAccountNS
{
    ...
    public class BankAccount
    {
        ...
        public const string CreditAmountEqualsZeroMessage = "Credit amount equals zero";
        ...
        public void Credit(double amount)
        {
            ...
            if (amount == 0)
            {
                throw new ArgumentOutOfRangeException("amount", amount, CreditAmountEqualsZeroMessage);
            }
